...
// Source: github.com/vuluu2k/simple_bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 db.TransferTxPrams) (db.TransferResult, error) {
	m.ctrl.T.Helper()
